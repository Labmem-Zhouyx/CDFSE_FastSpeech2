...
def to_device(data, device):
    if len(data) == 15:
        ...
        ref_linguistics = torch.from_numpy(ref_linguistics).long().to(device)
    ...
    if len(data) == 7:
        (ids, raw_texts, texts, src_lens, max_src_len, ref_mels, ref_mel_lens) = data
...
def log(
    logger, step=None, losses=None, fig=None, ref_alignment=None, audio=None, sampling_rate=22050, tag=""
):
