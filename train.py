...
def main(args, configs):
    ...
    print("Number of CDFSE_FastSpeech2 Parameters:", num_param)
        ...
        for batchs in loader:
            for batch in batchs:
                ...
                if step % log_step == 0:
                    ...
                    message2 = "Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Duration Loss: {:.4f}, PhnCls Loss: {:.4f}, PhnCls acc: {:.4f}, SpkCls Loss: {:.4f}".format(
                        *losses
                    )
                ...
                if step % synth_step == 0:
                    fig, ref_align, wav_reconstruction, wav_prediction, tag = synth_one_sample(
                        batch,
                        output,
                        vocoder,
                        model_config,
